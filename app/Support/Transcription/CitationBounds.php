...
/**
 * A citation is CITED on whole words, never on half of one and never on the
 ...
 *
 * This applies WHERE AN EDITOR CITES OR MOVES a citation herself, and only
 * there. It is deliberately NOT run after a text edit: whitespace typed
 * against a citation's words is the citation's and stays where the editor
 ...
 * split by an edit is reported by CitationIntegrity rather than mended.
 */
class CitationBounds
{
    /**
