 ...
 * order (`transcription_id`) or a catalogued ConjectureType::Reordering
 ...
 */
#[Fillable(['edition_id', 'range_start_canonical_passage_id', 'range_end_canonical_passage_id', 'transcription_id', 'conjecture_id', 'user_id'])]
class EditionPassageOrder extends Model
{
     ...
     * `transcription_id` is set instead.
     *
