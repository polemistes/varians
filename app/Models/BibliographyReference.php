 ...
 * Conjecture, or a segment of one Edition (keyed by edition and canonical
 * segment, like EditionComment — never through EditionSegment, so that
 * removing and re-adding a segment does not destroy its literature).
 *
 ...
 * itself; a segment's belong to the one edition that made them.
 *
 * @property int $id
 ...
 */
#[Fillable(['bibliography_item_id', 'conjecture_id', 'edition_id', 'segment_id', 'prenote', 'postnote', 'position'])]
