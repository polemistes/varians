...
function deletePage(item: ManuscriptPage) {
    const confirmed = window.confirm(
        `Delete page ${item.label}? Its photograph and the mappings of text onto it are deleted, and the text standing on it joins the previous page (in every transcript). Assignments to work segments are untouched.`,
    );
